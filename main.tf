...
module "rgroup" {
  source          = "./modules/rgroup-N01592008"
  rgroup-name     = "N01592008-RG"
...
module "network" {
  source          = "./modules/network-N01592008"
...
module "common" {
  source          = "./modules/common-N01592008"
...
module "vmlinux" {
  source            = "./modules/vmlinux-N01592008"
  nb_count          = "3"
  linux-vm-name     = "vmlinux-N01592008"
  rgroup-name       = module.rgroup.az-rgroup-name.name
  rgroup-location   = module.rgroup.az-rgroup-location.location
...
module "vmwindows" {
  source         = "./modules/windows-N01592008"
  windows_name   = {
    N01592008-vm1 = "Standard_B1s"
    N01592008-vm2 = "Standard_B1ms"
  }
  win_nb_count     = "1"
  subnet_id        = module.network.azurerm_subnet_name.id
  rgroup-name      = module.rgroup.az-rgroup-name.name
...
module "datadisk" {
  source                   = "./modules/datadisk-N01592008"
  rgroup-name              = module.rgroup.az-rgroup-name.name
  rgroup-location          = module.rgroup.az-rgroup-location.location
...
module "loadbalancer" {
  source           = "./modules/loadbalancer-N01592008"
  rgroup-name      = module.rgroup.az-rgroup-name.name
  rgroup-location  = module.rgroup.az-rgroup-location.location
...
module "database" {
  source      = "./modules/database-N01592008"
  rgroup-name     = module.rgroup.az-rgroup-name.name
  rgroup-location = module.rgroup.az-rgroup-location.location
  depends_on = [
    module.rgroup
